/*** Autogenerated by WIDL 6.2 from include/windows.gaming.input.idl - Do not edit ***/
            ...
            namespace Input {
                ...
                IGameController : public IInspectable
                {
                    virtual HRESULT STDMETHODCALLTYPE add_HeadsetConnected(
                        ABI::Windows::Foundation::ITypedEventHandler<ABI::Windows::Gaming::Input::IGameController*,ABI::Windows::Gaming::Input::Headset*> *value,
                    ...
                    virtual HRESULT STDMETHODCALLTYPE add_UserChanged(
                        ABI::Windows::Foundation::ITypedEventHandler<ABI::Windows::Gaming::Input::IGameController*,ABI::Windows::System::UserChangedEventArgs*> *value,
                        EventRegistrationToken *token) = 0;
            ...
            namespace Input {
                ...
                IRawGameControllerStatics : public IInspectable
                {
                    virtual HRESULT STDMETHODCALLTYPE add_RawGameControllerAdded(
                        ABI::Windows::Foundation::IEventHandler<ABI::Windows::Gaming::Input::RawGameController*> *value,
                        EventRegistrationToken *token) = 0;
    ...
    namespace Windows {
        namespace Foundation {
            ...
            ITypedEventHandler<ABI::Windows::Gaming::Input::IGameController*,ABI::Windows::Gaming::Input::Headset*> : public IUnknown
            {
                virtual void STDMETHODCALLTYPE Invoke(
                    IHeadset *sender,
                    ABI::Windows::Gaming::Input::IGameController *args) = 0;
